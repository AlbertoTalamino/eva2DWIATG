...
public class NotaEvaulacion {
	...
	//Constructores
	public NotaEvaulacion(String md_uuid, Timestamp md_fch, int id_nota_evaluacion, String cod_alumno, int nota_evaluacion,
			String cod_evaluacion) {
		super();
